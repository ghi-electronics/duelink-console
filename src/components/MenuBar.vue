<template>
    <div id="menu-bar" class="p-2 flex items-center space-x-8">
        ...
        <div class="flex items-center space-x-4">
            ...
            <a @click.prevent="$emit('firmware')">Firmware</a>
            <a
                class="text-sm"
...
const $emit = defineEmits(['demo', 'firmware', 'update:theme', 'updateTippy']);
