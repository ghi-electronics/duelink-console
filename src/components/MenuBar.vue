<template>
    <div class="h-full flex items-center space-x-2">
        <svg class="h-6 w-auto mx-2 text-geyser-2100 dark:text-bunker-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 266" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
        ...
        <span class="font-bold italic text-red-700 dark:text-red-400">BETA</span>
    </div>
</template>
